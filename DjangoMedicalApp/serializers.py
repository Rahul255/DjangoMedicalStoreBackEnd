...
from DjangoMedicalApp.models import Company,CompanyBank,Medicine,MedicalDetails,Employee,Customer
from DjangoMedicalApp.models import Bill,EmployeeSalary,CustomerRequest,CompanyAccount,EmployeeBank,BillDetails
